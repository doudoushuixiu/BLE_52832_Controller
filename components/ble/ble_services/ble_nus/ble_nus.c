...
#define BLE_UUID_NUS_TX_CHARACTERISTIC2 0x0008
...
static uint32_t tx_char_add2(ble_nus_t * p_nus, const ble_nus_init_t * p_nus_init)
{
    ble_gatts_char_md_t char_md;
    ble_gatts_attr_t    attr_char_value;
    ble_uuid_t          ble_uuid;
    ...
    memset(&char_md, 0, sizeof(char_md));
	  ...
	  char_md.char_props.notify = 1;   //¶ÁÐ´È¨ÏÞÉèÖÃ
    char_md.char_props.write         = 1;
    char_md.char_props.write_wo_resp = 1;
//	  char_md.char_props.read = 1;
    ...
    ble_uuid.type = p_nus->uuid_type;
    ble_uuid.uuid = BLE_UUID_NUS_TX_CHARACTERISTIC2;
...
uint32_t ble_nus_init(ble_nus_t * p_nus, const ble_nus_init_t * p_nus_init)
{
    ...
    err_code = tx_char_add2(p_nus, p_nus_init);
    VERIFY_SUCCESS(err_code);		
